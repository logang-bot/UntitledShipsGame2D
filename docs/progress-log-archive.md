# Progress Log Archive — Sessions 1-9

Sessions 1-9 (pre-boss, single-player fundamentals) archived out of
`progress-log.md` for length. This is a pure relocation, not a rewrite —
content below is unchanged from when it lived in `progress-log.md`,
...
[progress-log.md](progress-log.md) at Session 10.
